        ...
        if numeroRandom == 3: #33% de acontecer um evento
            ...
            if self.m_graph[nodo_inicial]:
                ...
                if nodo_adyacente in self.m_graph:
                    ...
                    print(f"Advertência: O nó adjacente '{nodo_adyacente}' não está no grafo.")
            else:
                print(f"Advertência: O nó inicial '{nodo_inicial}' não tem vizinhos.")
                nodo_adyacente = None
